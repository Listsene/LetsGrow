...
parser.add_argument(
    '--model_dir', type=str, default='tmp/plant_model',
...
parser.add_argument(
    '--train_data', type=str, default='tmp/plant_data/plant.data',
    help='Path to the training data.')

parser.add_argument(
    '--test_data', type=str, default='tmp/plant_data/plant.test',
