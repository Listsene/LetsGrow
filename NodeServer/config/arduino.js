...
module.exports = function(sensors, sections){
	var dataStack = [];
	var index=0;
	var value;
			...
			if(sensors.length >= max_size){
				...
				for(var io in normalized_sensor){
					...
					if(normalized_sensor[io]){
						...
						// 	sensorTuple.section1 = sections.section1;
						// if(sections.section2)
						// 	sensorTuple.section2 = sections.section2;
						// if(sections.section3)
						// 	sensorTuple.section3 = sections.section3;
